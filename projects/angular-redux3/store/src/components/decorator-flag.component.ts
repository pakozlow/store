...
export class DecoratorFlagComponent {
     ...
     * @readonly
     * @type {Reducer<any, UnknownAction> | undefined}
     */

    get reducer(): Reducer<any, UnknownAction> | undefined {
     ...
     * @param {Reducer<any, UnknownAction>} reducer - The reducer function.
     * @returns {NgRedux<any>} - The substore instance.
     */

    private factorySubstoreInstance(basePath: PathSelector, reducer: Reducer<any, UnknownAction>): AbstractStore<any> {
